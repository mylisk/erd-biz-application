package com.erdp.bizm.application.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.erdp.bizm.application.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.erdp.bizm.application.repository.UserRepository.USERS_BY_EMAIL_CACHE);
